...
int1 = int(input("Enter the first index: "))
int2 = int(input("Enter the second index: "))
lower= min(int1,int2)
upper= max(int1,int2)

if 0 <= lower < len(word_list) and 0 < upper <= len(word_list):
    print(" ".join(word_list[lower:upper]))
else:
